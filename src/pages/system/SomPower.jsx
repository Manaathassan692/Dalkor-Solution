    ...
    <>
      <div className="flex bg-gray-100 min-h-screen">
        ...
        <aside className="w-48 bg-blue-700 shadow-lg">
          <div className="p-4">
            <h2 className="text-xl font-bold text-white">Sompower Dashboard</h2>
          </div>
          <nav className="mt-4">
            <ul>
              <li>
                <span className="block py-2 px-4 text-white text-2xl font-bold">Sompower Power</span>
              </li>
            </ul>
          </nav>
        </aside>

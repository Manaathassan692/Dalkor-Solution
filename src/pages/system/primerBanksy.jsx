...
const handleData =()=>{
    axios.get("http://localhost:9000/read/premier").then((res)=>{
        setData(res.data)
        console.log(res.data)
    }).catch((error)=>
        console.log(error)
...
useEffect(()=>{
    ...
    <aside className="w-64 bg-blue-700 shadow-lg">
      ...
      <nav className="mt-6">
        <ul>
          <li>
            <span className="block py-2 px-6 text-white text-4xl font-bold">premier bank
            </span>
          </li>
        </ul>
      </nav>
